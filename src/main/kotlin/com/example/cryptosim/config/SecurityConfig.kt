...
import com.example.cryptosim.service.JwtUserDetailsService
...
class SecurityConfig {
    ...
    @Bean
    fun authenticationProvider(userDetailsService: JwtUserDetailsService, passwordEncoder: PasswordEncoder): AuthenticationProvider =
